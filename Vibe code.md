...
-tiếp đó là cãi lộn và phải chốt được công nghệ, database, kiến trúc và cấu trúc folder ,clean code, nhớ thêm solid và có oop nếu cần, xử lý asynhandller, errormiddleware, front thì nhớ dùng gsap và motion cho landing page hay web,...
