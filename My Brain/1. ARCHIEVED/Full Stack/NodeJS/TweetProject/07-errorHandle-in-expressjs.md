---
date: 2025-05-09T12:13:00
---
Related : [[NodeJS]]
Tag: #nodejs #prj #errorhandle #expressjs
___
là bình thường ko có -T nodemon sẽ dịch ts ròi buid đẻnó chảy có -T bỏ qua bước đọc Ts nên ko cần chạy
...
![[image-66.png]]
    khi mà  wrapAsync(registerController) chạy thì nó sẽ return ra 1 `request handler`
  ![[image-67.png|625]]
